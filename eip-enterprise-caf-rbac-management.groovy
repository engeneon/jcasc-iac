   ...
   CURRENT_BRANCH="main"
      ...
      stages {
        ...
        stage("Extracting global environment variables") {
         steps {
           dir("/var/jenkins_home/workspace/rbac-management/orion/configuration/") {
        ...
        stage("Configuring Azure Access") {
            steps {
              ...
              dir("/var/jenkins_home/workspace/rbac-management/") {
                deleteDir()
              }
        ...
        stage("Deploying RBAC Framework") {
          steps {
            dir("/var/jenkins_home/workspace/rbac-management/orion/level-0/aad-rbac") {  
