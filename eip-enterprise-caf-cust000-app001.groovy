pipelineJob("customer000-app000") {
  definition {
    cps {
         sandbox(true)
script("""
      ...
      stages {
        ...
        stage("Configuring Azure Access") {
            steps {
              ...
              dir("/var/jenkins_home/workspace/customer000-app000/") {
                deleteDir()
              }
        ...
        stage("Extracting global environment variables") {
         steps {
           dir("/var/jenkins_home/workspace/customer000-app000/orion/configuration/") {
        ...
        stage("Deploying Application 000") {
         steps {
           dir("/var/jenkins_home/workspace/customer000-app000/orion/level-4/applications/azure-sql-database") {  
                sh '''#!/bin/bash
                echo "Customer 000 Application 000 ..."
                pwd
                ls -l
                ./deploy.sh
                '''           
